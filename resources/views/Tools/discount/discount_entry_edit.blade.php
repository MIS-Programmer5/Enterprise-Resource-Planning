...
tr:nth-child(even) {
  ...
  <body>
      <h4>Discount Level Data Entry</h4>
        <div class="container">
                <form method ="post" action ="{{route('discount.edit',['discounts' => $discounts])}}">
                  @csrf
                  @method('put')
                  <div class="row">
                        <div class="row">
                          ...
                          <label for="Dfrom">Date From:</label>
                             <input type="date" id="Dfrom" name="Dfrom">
                          <label for="Dto">Date To:</label>
                             <input type="date" id="Dto" name="Dto">
                        ...
                        <div class="row">
                          ...
                          <div class="col-55">
                            <input type="text" name="discname" placeholder="Discount name.." value ="{{$discounts->discname}}" />
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-20">
